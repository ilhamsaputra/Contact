...
class BaseViewController : UIViewController {
    ...
    // create alert
    func createAlert(title: String = "", message: String, firstButtonTitle: String = "", secondButtonTitle: String = "", firstCompletion: alertCallBack?, secondCompletion: alertCallBack? = nil, withTwoButton: Bool = false){
